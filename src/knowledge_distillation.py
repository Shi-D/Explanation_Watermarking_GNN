...
if __name__ == '__main__':
    ...
    parser.add_argument('--numLayers_student',            type=int,               default=args.numLayers-1,                  help='Number of layers in GNN.')
    ...
    config.KD_student_node_classifier_kwargs['numLayers']=args.numLayers_student
    ...
    for _ in range(args.num_iters):
        ...
        data_training_path = f'{parent_dir}/training_results/{args.dataset_name}/'
