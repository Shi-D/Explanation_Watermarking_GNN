...
if __name__ == '__main__':
    ...
    arch_folder = []
    folder_contents = [f for f in os.listdir(train_folder) if len(f)>3 and f[:4]=='arch']
    print('folder_contents:')
    print(folder_contents)
    for f in folder_contents:#os.listdir(train_folder):
    ...
    try:
        ...
        print('eligible_model_folders:',eligible_model_folders)
    ...
    ### gather subgraphs
    for size in [subgraph_size_as_fraction]:
